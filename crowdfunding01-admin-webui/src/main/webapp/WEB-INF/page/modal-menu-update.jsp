...
<div id="menuUpdateModal" class="modal fade" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="modal-footer">
                    <button id="menuUpdateBtn" type="button" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i> 更新</button>
                </div>
            </form>
        </div>
    </div>
